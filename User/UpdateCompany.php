<?php
	...
	$tmp_banner_img = $_FILES['fileBanner']['tmp_name'];
		...
		file_put_contents("../Admin/company_settings/company_info.php",str_replace($find,$replace,file_get_contents("../Admin/company_config.php","true")),true);
		move_uploaded_file($tmp_banner_img,"../Admin/design/$site_banner_img");

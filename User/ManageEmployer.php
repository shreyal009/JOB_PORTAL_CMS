...
<!--#############################################PENDING EMPLOYERS############################################-->
		...
		<tr>
		          <td height="27" bgcolor="#A0B9F3"><strong>Pending Employers</strong></td>
	        </tr>
...
<!--#############################################CONFIRMED EMPLOYERS############################################-->
		...
		<tr>
		          <td height="27" bgcolor="#A0B9F3"><strong>Confirmed Employers</strong></td>
	        </tr>
...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $City;?></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $CP;?></strong></div></td>
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DetailEmp.php?EmpId=<?php echo $Id;?>">Details</a></strong></div></td>
                        </tr>
                        <?php
}
// Retrieve Number of records returned

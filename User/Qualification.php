        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="26"><form id="form1" method="post" action="InsertQual.php">
                        <table width="100%" height="109" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td height="36"><span class="style9">Qualification Name:</span></td>
                            <td>
                              <label>
                              <input required type="text" name="txtQual" id="txtQual" />
                              </label>
                              </td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td><label>
                              <input required type="submit" name="button" id="button" value="Submit" />
                            </label></td>
                          </tr>
</table>
                    </form></td>
                  ...
                  <tr>
                    <td height="25" bgcolor="#A0B9F3"><span class="style3">Existing Qualifications</span></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                        <tr>
                          ...
                          <th bgcolor="#1CB5F1"><div align="left" class="style11 style7 style8">Qualification</div></th>
...
$sql = "select * from qualification_master";
// Execute query
$result = sqlquery($sql);
...
?>
                        <tr>
                          ...
                          <td><div align="left" class="style11 style7 style8"><?php echo $Qual;?></div></td>
                          <td><div align="left" class="style11 style7 style8"><a href="EditQual.php?QualId=<?php echo $Id;?>">Edit</a></div></td>
                          <td><div align="left" class="style11 style7 style8"><a href="DeleteQual.php?QualId=<?php echo $Id;?>">Delete</a></div></td>
                        </tr>
                        <?php
}
...
?>
                  ...
                  <tr>
                    <td height="26"><form method="post" action="InsertQual.php">
                      <table width="100%" height="109" border="0" cellpadding="0" cellspacing="0">
                        </table>
                    </form></td>
                  </tr>
